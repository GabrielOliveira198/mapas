...
public class GastosDAOHibernate implements GastosDAO{
    ...
    public List<Gastos> buscaCidadesEstado(String estado) {
         String hql = "select g from Gastos g where g.estado = :estado";//"select sum(g.valor) from gastos g where g.estado = :estado";
         Query consulta = this.session.createQuery(hql);
    ...
    public List<String> listaEstados() {
        String hql = "select distinct estado from Gastos";//"select sum(g.valor) from gastos g where g.estado = :estado";
         Query consulta = this.session.createQuery(hql);
         return consulta.list();
    }
    ...
    public List<String> listaCidades() {
        String hql = "select distinct cidade from Gastos";//"select sum(g.valor) from gastos g where g.estado = :estado";
         Query consulta = this.session.createQuery(hql);
         return consulta.list();
    }
    ...
    public List<String> listaEmpresas() {
        String hql = "select distinct empresa from Gastos";//"select sum(g.valor) from gastos g where g.estado = :estado";
         Query consulta = this.session.createQuery(hql);
         return consulta.list();
    }
